...
Use the `write` tool to save the report. The orchestrator provides the target path in your task (typically `.pi/subagents/YYYY-MM-DD-<name>/visual-test-report.md`). Report the exact path back in your summary.
